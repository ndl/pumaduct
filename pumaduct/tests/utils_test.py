...
"""Tests PuMaDuct utilities functions."""
...
class UtilsTest(unittest.TestCase):
  ...
  def test_query_json_path(self):
    json = {"a": {"b": {"c": 1}}}
    self.assertEqual(query_json_path(json, "a", "b", "c"), 1)
    self.assertIsNone(query_json_path(json, "a", "b", "d"))
